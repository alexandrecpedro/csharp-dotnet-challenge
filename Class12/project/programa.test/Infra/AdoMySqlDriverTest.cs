...
public class AdoMySqlDriverTest
{
    ...
    {
        await new AdoMySqlDriver<Cliente>(this.testFilePath).DeleteAll();
        await new AdoMySqlDriver<ContaCorrente>(this.testFilePath).DeleteAll();
    }

    [TestMethod]
    public async Task TestandoDriverJsonParaClientes()
    {
        var jsonDriver = new AdoMySqlDriver<Cliente>(this.testFilePath);
    ...
    {
        var jsonDriver = new AdoMySqlDriver<ContaCorrente>(this.testFilePath);
